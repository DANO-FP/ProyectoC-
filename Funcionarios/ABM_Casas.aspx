<%@ Page Title="BRS" Language="C#" MasterPageFile="~/MPFuncionarios.Master" AutoEventWireup="true" CodeBehind="ABM_Casas.aspx.cs" Inherits="Funcionarios.ABM_Casas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width:100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnModificacion" runat="server" Text="Modificar" 
                        onclick="btnModificacion_Click" CssClass="Button" />
                </td>
            </tr>
            <tr>
                <td class="Names">
                ...
                <td>
                    <asp:Button ID="btnLimpiar" runat="server" EnableTheming="True" 
                        Text="Limpiar" onclick="btnLimpiar_Click" CssClass="Button" />
                </td>
            </tr>
            <tr>
                <td class="Names">
            ...
            <tr>
                <td class="Names">
                    Metros cuadrados terreno:</td>
                <td>
                    <asp:TextBox ID="txtMtTerreno" runat="server" style="margin-left: 0px" 
                        CssClass="Tbox"></asp:TextBox>
                </td>
                <td>
                    &nbsp;</td>
            ...
            <tr>
                ...
                <td class="style1">
                    <asp:CheckBox ID="chbPatio" runat="server" CssClass="Check" />
                </td>
                <td class="style1">
                    &nbsp;</td>
            </tr>
