<%@ Page Title="BRS" Language="C#" MasterPageFile="~/MPFuncionarios.Master" AutoEventWireup="true" CodeBehind="ABM_LocalComercial.aspx.cs" Inherits="Funcionarios.ABM_LocalComercial" %>
...
<div class="Content2">
            ...
            <tr>
                <td class="Names">
                    Habilitacion:</td>
                <td class="style1">
                    <asp:CheckBox ID="chbHabilitacion" runat="server" CssClass="Check" />
                </td>
                <td class="style1">
                </td>
            </tr>
